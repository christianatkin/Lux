...
SubShader { 
	...
	#define LUX_LINEAR //LUX_GAMMA
	#define DIFFCUBE_ON //DIFFCUBE_OFF
	#define SPECCUBE_ON //SPECCUBE_OFF
...
//	#define LUX_AO_OFF
	...
	void surf (Input IN, inout SurfaceOutputLux o) {  
		...
		//	o.Specular = _RoughnessFac * spec_albedo.a;
		//#endif
